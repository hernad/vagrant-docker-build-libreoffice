...
if [ ! -f /root/ftp_server_path.config ] ; then
...
if [ ! -f /root/ftp_user_password.config ] ; then
...
FTP_PATH=`cat /root/ftp_server_path.config`
FTP_PWD=`cat /root/ftp_user_password.config`
function get_file() { 
